...
export const AgentKindValueSchema = z
  .string()
  .refine((value) => Object.values(AgentKindEnumSchema.enum).includes(value as AgentKindEnum), {
...
export const AgentNumValueSchema = z.number().describe("Agent instance number.");
export type AgentNumValue = z.infer<typeof AgentNumValueSchema>;

export const AgentConfigVersionValueSchema = z.number().describe("Agent config version number.");
export type AgentConfigVersionValue = z.infer<typeof AgentConfigVersionValueSchema>;
