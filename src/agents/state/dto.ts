...
export type AgentConfigLifecycleEvent = z.infer<typeof BaseAgentConfigLifecycleEventSchema>;

export const AgentConfigCreateEventSchema = BaseAgentConfigLifecycleEventSchema.extend({
  kind: z.literal(AgentEventKindEnum.enum.agent_config_create),
  config: AgentConfigSchema,
});
export type AgentConfigCreateEvent = z.infer<typeof AgentConfigCreateEventSchema>;

export const AgentConfigUpdateEventSchema = BaseAgentConfigLifecycleEventSchema.extend({
  kind: z.literal(AgentEventKindEnum.enum.agent_config_update),
  config: AgentConfigSchema,
});
export type AgentConfigUpdateEvent = z.infer<typeof AgentConfigUpdateEventSchema>;

export const AgentConfigDestroyEventSchema = BaseAgentConfigLifecycleEventSchema.extend({
  kind: z.literal(AgentEventKindEnum.enum.agent_config_destroy),
});
export type AgentConfigDestroyEvent = z.infer<typeof AgentConfigDestroyEventSchema>;
...
export const AssignedEventSchema = <TAssignment extends z.ZodType>(assignmentSchema: TAssignment) =>
...
export const TaskAssignedEventSchema = AssignedEventSchema(TaskRunSchema).extend({
