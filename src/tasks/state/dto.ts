...
export type AgentTypeRegisterEvent = z.infer<typeof AgentTypeRegisterEventSchema>;
...
export type BaseTaskConfigLifecycleEvent = z.infer<typeof BaseTaskConfigLifecycleEventSchema>;

export const TaskConfigCreateEventSchema = BaseTaskConfigLifecycleEventSchema.extend({
...
export const TaskConfigUpdateEventSchema = BaseTaskConfigLifecycleEventSchema.extend({
...
export const TaskConfigDestroyEventSchema = BaseTaskConfigLifecycleEventSchema.extend({
  kind: z.literal(TaskEventKindEnum.enum.task_config_destroy),
});
export type TaskConfigDestroyEvent = z.infer<typeof TaskConfigDestroyEventSchema>;
...
export type BaseTaskRunLifecycleEvent = z.infer<typeof BaseTaskRunLifecycleEventSchema>;
...
export type TaskHistoryEntryCreateEvent = z.infer<typeof TaskHistoryEntryCreateEventSchema>;
